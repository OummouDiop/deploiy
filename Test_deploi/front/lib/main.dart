...
class _CalculatorPageState extends State<CalculatorPage> {
  ...
  // URL de votre API Django - changez cette URL pour la production
  final String apiUrl = 'https://votre-api-django.herokuapp.com/api/add/'; // Pour production
  // final String apiUrl = 'http://127.0.0.1:8000/api/add/'; // Pour développement local
